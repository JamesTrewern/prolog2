...
impl<'a> Proof<'a> {
    ...
    fn prove(&mut self, n_id: usize, depth: usize) -> bool {
        if depth == 5 {
            return false;
        }
    ...
    fn prove_choice(&mut self, n_id: usize, mut choice: Choice, depth: usize) -> bool {
    ...
    // fn retry_from(&mut self, n_id: usize, depth: usize) -> bool{
    ...
    fn retry(&mut self, mut path: Vec<usize>, choice: Choice, depth: usize) -> bool {
