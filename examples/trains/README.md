...
Michalski's trains problem. There are two sets of trains: Eastbound and Westbound. Descriptors for the trains include: number, shape and lengths of the car, shape of load, and so on. The task is to determine classification rules to distinguish Eastbound trains from Westbound ones. 

## Background Knowledge

<!-- embed-start: trains.pl -->
```prolog
%% metarules
P(A):-Q(A),{P,Q}.
P(A):-Q(A),R(A),{P,Q,R}.
